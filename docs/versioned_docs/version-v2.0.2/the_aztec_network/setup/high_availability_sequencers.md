...
For the complete step-by-step process with detailed examples, see the [Advanced Keystore Patterns guide - High Availability Sequencer Setup](../operation/keystore/advanced_patterns.md#high-availability-sequencer-setup).
