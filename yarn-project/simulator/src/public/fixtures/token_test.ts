...
async function checkBalance(
  ...
  expectToBeTrue(balResult.appLogicReturnValue !== undefined);
  expectToBeTrue(balResult.appLogicReturnValue!.length == 1);
  expectToBeTrue(balResult.appLogicReturnValue![0].toBigInt() == expectedBalance);
}
